  ...
  const renderContent = () => {
    switch (activeSection) {
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-lg shadow-sm border p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">₹2,45,680</p>
                  </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Devotees</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div className="space-y-4">
                  {[
                    { name: 'Rajesh Kumar', amount: '₹5,000', time: '2 hours ago', type: 'General Fund' },
                    { name: 'Priya Sharma', amount: '₹2,500', time: '4 hours ago', type: 'Festival Fund' },
                    { name: 'Anonymous', amount: '₹10,000', time: '6 hours ago', type: 'Construction' },
                    { name: 'Amit Patel', amount: '₹1,000', time: '1 day ago', type: 'General Fund' },
                  ].map((donation, index) => (
                    <div key={index} className="flex items-center justify-between py-2">
                      <div>
                        <p className="font-medium text-gray-900">{donation.name}</p>
                        <p className="text-sm text-gray-500">{donation.type} • {donation.time}</p>
                      </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div className="space-y-4">
                  {[
                    { name: 'Diwali Celebration', date: 'Nov 12, 2024', attendees: '500+' },
                    { name: 'Monthly Abhishek', date: 'Nov 15, 2024', attendees: '200+' },
                    { name: 'Bhajan Sandhya', date: 'Nov 18, 2024', attendees: '150+' },
                    { name: 'Annakut Festival', date: 'Nov 25, 2024', attendees: '800+' },
                  ].map((event, index) => (
                    <div key={index} className="flex items-center justify-between py-2">
                      <div>
      ...
      case 'donations':
        return (
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Donation Management</h2>
            <div className="space-y-4">
              <div className="flex justify-between items-center border-b pb-4">
                <div>
                  <h3 className="font-semibold">Rajesh Kumar</h3>
                  <p className="text-gray-600">rajesh@email.com • +91 98765 43210</p>
                </div>
              ...
              <div className="flex justify-between items-center border-b pb-4">
                <div>
                  ...
                  <p className="text-gray-600">priya@email.com • +91 87654 32109</p>
                </div>
                <div className="text-right">
        ...
        return (
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900">Temple Gallery</h2>
              <button 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                { title: "Diwali Celebration 2024", description: "Beautiful decorations during Diwali festival" },
                { title: "Morning Aarti", description: "Daily morning prayer session" },
                { title: "Temple Renovation", description: "Recent renovation of the main hall" },
                { title: "Festival Preparations", description: "Volunteers preparing for upcoming festival" },
                { title: "Evening Prayer", description: "Devotees during evening prayer" },
                { title: "Temple Architecture", description: "Beautiful carved pillars of the temple" }
              ].map((item, index) => (
      ...
      case 'expenses':
        return (
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="space-y-4">
              {[
                { category: 'Maintenance', amount: '₹15,000', date: 'Nov 10, 2024', description: 'Temple cleaning and repairs' },
                { category: 'Utilities', amount: '₹8,500', date: 'Nov 09, 2024', description: 'Electricity and water bills' },
                { category: 'Festival Supplies', amount: '₹12,000', date: 'Nov 08, 2024', description: 'Decorations and materials for Diwali' },
                { category: 'Staff Salary', amount: '₹25,000', date: 'Nov 01, 2024', description: 'Monthly salary for temple staff' },
              ].map((expense, index) => (
      ...
      case 'events':
        return (
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="space-y-4">
              {[
                { name: 'Diwali Celebration', date: 'Nov 12, 2024', status: 'Upcoming', description: 'Grand celebration with lights and prayers', time: '6:00 PM - 9:00 PM' },
                { name: 'Monthly Abhishek', date: 'Nov 15, 2024', status: 'Planned', description: 'Monthly ritual ceremony for the deity', time: '7:00 AM - 8:00 AM' },
                { name: 'Bhajan Sandhya', date: 'Nov 18, 2024', status: 'Planned', description: 'Evening devotional music session', time: '7:00 PM - 8:30 PM' },
                { name: 'Annakut Festival', date: 'Nov 25, 2024', status: 'Upcoming', description: 'Food offering festival with community feast', time: '10:00 AM - 2:00 PM' },
              ].map((event, index) => (
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Temple Admin Dashboard</h1>
