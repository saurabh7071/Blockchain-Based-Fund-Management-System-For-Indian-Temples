...
import { ChevronRight, Shield, Users, TrendingUp, Zap, CheckCircle, Menu, X, ArrowRight, Star, Globe, Lock, Eye } from 'lucide-react';

const TempleLandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-yellow-50">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#temples" className="text-gray-700 hover:text-orange-600 transition-colors">Temples</a>
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 bg-white/95 backdrop-blur-lg z-40 md:hidden">
          <div className="flex flex-col items-center justify-center h-full space-y-8 text-lg">
            <a href="#features" className="text-gray-700 hover:text-orange-600" onClick={() => setIsMenuOpen(false)}>Features</a>
            <a href="#how-it-works" className="text-gray-700 hover:text-orange-600" onClick={() => setIsMenuOpen(false)}>How It Works</a>
            <a href="#temples" className="text-gray-700 hover:text-orange-600" onClick={() => setIsMenuOpen(false)}>Temples</a>
            <a href="#contact" className="text-gray-700 hover:text-orange-600" onClick={() => setIsMenuOpen(false)}>Contact</a>
            <button className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-3 rounded-full">
              Get Started
            </button>
          </div>
        </div>
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8">
              Transparent, secure, and decentralized donation management system for Indian temples using blockchain technology
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-xl transform hover:scale-105 transition-all flex items-center justify-center">
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Built on blockchain technology to ensure complete transparency and security in temple fund management
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
              ...
              <p className="text-gray-600">
                Every donation is recorded on the blockchain, ensuring complete transparency and accountability in fund usage.
              </p>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-800">Secure Transactions</h3>
              <p className="text-gray-600">
                Advanced encryption and smart contracts ensure your donations reach the intended temple safely and securely.
              </p>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
              ...
              <p className="text-gray-600">
                Track your donations in real-time and see exactly how funds are being utilized for temple development.
              </p>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-800">Community Governance</h3>
              <p className="text-gray-600">
                Participate in temple decisions through decentralized governance and voting mechanisms.
              </p>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
              ...
              <p className="text-gray-600">
                Advanced analytics and reporting tools help temples optimize their fund management strategies.
              </p>
            </div>
            ...
            <div className="bg-white/70 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-800">Instant Receipts</h3>
              <p className="text-gray-600">
                Get instant digital receipts and tax certificates for all your donations with blockchain verification.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-20 bg-gradient-to-r from-orange-100 to-red-100 px-6">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="bg-gradient-to-r from-orange-600 to-red-500 bg-clip-text text-transparent">
            ...
            <p className="text-xl text-gray-600">Simple steps to start your transparent donation journey</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Connect your digital wallet to start making secure blockchain transactions</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Browse and select from hundreds of verified temples across India</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Make your donation and track its usage in real-time on the blockchain</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-orange-500 to-red-500 rounded-3xl p-12 text-white">
            ...
            <p className="text-xl mb-8 opacity-90">
              Join thousands of devotees who trust Digital Seva for transparent and secure temple donations
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-orange-600 px-8 py-4 rounded-full text-lg font-semibold hover:shadow-xl transform hover:scale-105 transition-all">
                Launch Dashboard
              </button>
      ...
      <footer className="bg-gray-900 text-white py-16 px-6">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Revolutionizing temple fund management through blockchain technology and complete transparency.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Digital Seva. All rights reserved. Built with devotion for digital transparency.</p>
          </div>
        </div>
      </footer>
    </div>
...
export default TempleLandingPage;