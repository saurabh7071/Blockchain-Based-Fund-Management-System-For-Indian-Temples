  ...
  const handleLogin = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:5050/api/v1/superAdmin/login-superAdmin",
        {
          method: "POST",
          headers: {
    ...
    <AuthWrapper role="superAdmin">
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex items-center justify-center p-4">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-purple-200/30 to-pink-200/30 rounded-full blur-3xl animate-pulse"
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="text-center mt-8 space-y-3">
            <p className="text-gray-600 font-medium">
              © 2025 Temple Fund Management System
            </p>
